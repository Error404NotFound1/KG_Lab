...
\includegraphics[width=1\textwidth]{figures/系统总体架构图.png}
\caption{知识图谱构建与可视化系统总体架构图}
\label{fig:total-arch}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=1\textwidth]{figures/项目实施技术路线图.png}
\caption{项目实施技术路线图}
\label{fig:roadmap}
\end{figure}
...
系统的交互流程从项目管理开始。图~\ref{fig:home-ui} 展示了系统的前端首页，用户可以在此查看已构建的图谱列表并进入特定的分析任务。图~\ref{fig:create-ui} 和 图~\ref{fig:upload-ui} 分别展示了新建图谱任务和添加文献文档的交互界面。这些界面通过响应式设计保证了操作的直观性，并提供了即时的进度反馈与错误提示。

\begin{figure}[H]\centering
\includegraphics[width=0.8\textwidth]{figures/前端首页.png}
\caption{系统项目管理首页}
\label{fig:home-ui}
\end{figure}
\begin{figure}[H]\centering
\includegraphics[width=0.8\textwidth]{figures/新建图谱界面截图.png}
\caption{新建图谱任务界面}
\label{fig:create-ui}
\end{figure}
\begin{figure}[H]\centering
\includegraphics[width=0.8\textwidth]{figures/添加文档功能截图.png}
\caption{添加文献文档界面}
\label{fig:upload-ui}
\end{figure}
